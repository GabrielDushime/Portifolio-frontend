...
const ContactSection = () => {
  ...
  const socialLinks = [
    { icon: <LinkedinOutlined />, url: 'https://www.linkedin.com/in/eng-gabriel-dushime-b0589325a/', color: '#7EEAEA' },
    { icon: <GithubOutlined />, url: 'https://github.com/GabrielDushime', color: '#7EEAEA' },
    { icon: <TwitterOutlined />, url: 'https://x.com/_Eng_Gabriel_', color: '#7EEAEA' },
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  ...
                  <div style={{ marginBottom: '20px' }}>
                    ...
                    <a 
                      href="mailto:dushimegabriel@gmail.com"
                      style={{ 
                        color: '#7EEAEA', 
                        fontSize: '1.1rem',
                        display: 'inline-flex',
