            ...
            <Col xs={24} md={12}>
              <motion.div variants={itemVariants} className="h-full">
                ...
                >
                  ...
                  >
                    Hi! My name is <Text strong style={{ color: '#FFFFFF' }}>Gabriel Dushime</Text> and I enjoy creating, designing and implementing digital solutions. 
                    My journey in software development began with a passion for building innovative, scalable applications
                  ...
                  >
                    I'm currently pursuing a <Text strong style={{ color: '#7EEAEA' }}>Bachelor of Computer Engineering with Honours</Text> at the University of Rwanda (2021-2025),
                    where I'm building a strong technical foundation in software engineering principles.
                  </Paragraph>
                  ...
                  >
                    From February to October 2024, I participated in the <Text strong style={{ color: '#7EEAEA' }}>Andela Technical Program</Text>, which significantly enhanced my skills
                  ...
                  >
                    Most recently, I worked at <Text strong style={{ color: '#7EEAEA' }}>Nexgen Essential Ltd</Text> as a Frontend Developer Intern, where I developed a scalable 
                    property management system using Next.js, JavaScript, and Ant Design. I also interned at the <Text strong style={{ color: '#7EEAEA' }}>National Bank of Rwanda</Text> as a Full-Stack Software Developer, where I built an Archive Management System using NestJS, TypeScript, and PostgreSQL.
                  </Paragraph>
                </Card>
              </motion.div>
            </Col>
